	...
	, d_ptr(new Value2A429Private(this))
{
	...
	comboBoxValueSDI->lineEdit()->setReadOnly(true);
	comboBoxValueSDI->lineEdit()->setAlignment(Qt::AlignCenter);
	comboBoxValueSSM->lineEdit()->setReadOnly(true);
	comboBoxValueSSM->lineEdit()->setAlignment(Qt::AlignCenter);
